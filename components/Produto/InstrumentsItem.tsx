...
export default function InstrumentsItem(){
  ...
  const position = 1
  const instrumento = teclado//violao 
  const parcelado = (parseFloat(violao[position].newPrice)/10).toFixed(2);
  ...
  <div className="mt-14">
        <div className="container mx-auto flex">
          <div className="mx-auto max-w-[50em]">
            <Image
              ...
              width={550}
              height={700}
              className="rounded-2xl border-2 border-slate-400 border-opacity-45 px-8 bg-white"
            />
          </div>
      ...
      <div className="container mx-auto mb-10 mt-20 border-t-2 border-[#C7A315]">
        ...
        <div className="bg-gray-50 p-6 font-sans text-gray-900">
          <h1 className="mb-4 text-2xl font-bold">{violao[position].nome}</h1>
