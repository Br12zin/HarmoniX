    ...
    >
      ...
      <div className="oculto flex h-80 w-full">
        ...
        <div className="me-6 ms-6 flex h-full w-60 flex-col justify-center">
          <h2 className="mb-5 items-center text-2xl text-[#ECECEC]">
            Telefones:
          </h2>
          <div>
        ...
        <div className="ms-20 flex h-full w-60 items-center justify-center text-black">
          <button>
            <a href="https://www.instagram.com/" target="_blank">
              <Instagram className="me-2 size-8 text-[#ECECEC]" />
            </a>
          </button>
          <button>
            <a href="https://www.facebook.com/" target="_blank">
              <Facebook className="me-2 ms-2 size-8 text-[#ECECEC]" />
            </a>
          </button>
          <button>
            <a href="https://www.youtube.com/" target="_blank">
              <Youtube className="me-2 ms-2 size-8 text-[#ECECEC]" />
            </a>
          </button>
          <button>
            <a href="https://web.whatsapp.com/" target="_blank">
              <Whatsapp className="ms-2 size-8" fill="#ECECEC" />
            </a>
          </button>
        </div>
      </div>
