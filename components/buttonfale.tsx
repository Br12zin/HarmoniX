...
export default function Button({ title = "", num1 = "", num2 = "", img = "" }) {
  return (
    <>
      <button className="flex h-[50%] w-[25%] transform flex-col items-center rounded-xl bg-[#ececec] p-20 transition-transform duration-300 hover:scale-110 hover:shadow-xl">
