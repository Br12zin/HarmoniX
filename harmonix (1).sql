...
--
-- Host: mysql:3306
-- Tempo de geração: 03/07/2025 às 20:16
...
INSERT INTO `clientes` (`id_cliente`, `cliente`, `data_nascimento`, `email`, `senha`, `telefone`, `telefone_residencial`, `cep`, `logradouro`, `numero`, `cidade`, `estado`, `complemento`, `bairro`, `created_at`, `updated_at`) VALUES
(1, 'Manoel Gomes', '1990-01-01', 'sdsad@hotmail.com', '123456', '11999999999', '11333333333', '01000-000', 'Rua Exemplo', 123, 'São Paulo', 'SP', 'Apto 1', 'Centro', '2025-06-18 02:42:34', '2025-06-18 02:42:34');
...
INSERT INTO `usuarios` (`id_usuario`, `nome`, `email`, `senha`, `created_at`) VALUES
(1, 'victor', 'victor@email.com', '8cb2237d0679ca88db6464eac60da96345513964', '2025-06-30 17:26:46');
...
--
ALTER TABLE `produtos`
  MODIFY `id_produto` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
